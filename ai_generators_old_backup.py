...
def generate_client_oneliner_local(prompt_text: str) -> str:
    ...
    logger.debug(f"Generating sector label (max_words={max_words})")
...
def generate_client_oneliner(prompt_text: str) -> str:
    """Generate anonymous client one-liner description."""
    logger.debug("Generating client one-liner")
...
def generate_project_highlight_3para(prompt_text: str) -> str:
    """Generate 3-paragraph project highlight."""
    logger.debug("Generating 3-paragraph project highlight")
...
def generate_generic_content(prompt_text: str, tone: str = "short") -> str:
    ...
    logger.debug(f"Generating generic content (tone={tone})")
